package org.hle.aggregator.tests;
...
public class StockUpdateTest {
    ...
    private static final Logger log = LoggerFactory.getLogger(StockUpdateTest.class);
    ...
    public void stockUpdatesTest() {
        var list = restTemplate.execute(STOCK_UPDATES_ENDPOINT.formatted(port),
                HttpMethod.GET,
                null,
                this::getResponse);
