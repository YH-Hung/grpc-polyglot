...
Namespace ComExamplePriority
    ...
    Public Class PriorityTestServiceClient
        ...
        Public Function TestPriorityAsync(request As PriorityRequest) As Task(Of PriorityResponse)
            Return TestPriorityAsync(request, CancellationToken.None)
        End Function

        Public Function TestPriorityAsync(request As PriorityRequest, cancellationToken As CancellationToken) As Task(Of PriorityResponse)
            Return TestPriorityAsync(request, cancellationToken, Nothing)
        End Function

        Public Async Function TestPriorityAsync(request As PriorityRequest, cancellationToken As CancellationToken, Optional timeoutMs As Integer? = Nothing) As Task(Of PriorityResponse)
            Return Await PostJsonAsync(Of PriorityRequest, PriorityResponse)("/test_namespace_priority/test-priority/v1", request, cancellationToken, timeoutMs).ConfigureAwait(False)
        End Function
