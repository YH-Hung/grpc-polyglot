...
// The response message containing the greetings and server info.
...
func (x *HelloReply) GetServerName() string {
	if x != nil {
		return x.ServerName
	}
	return ""
...
func (x *HelloReply) GetArchitecture() string {
	if x != nil {
...
const file_helloworld_proto_rawDesc = "" +
	...
	"\farchitecture\x18\x04 \x01(\tR\farchitecture2I\n" +
	"\aGreeter\x12>\n" +
	"\bSayHello\x12\x18.helloworld.HelloRequest\x1a\x16.helloworld.HelloReply\"\x00BBZ@github.com/yinghanhung/grpc-polyglot/routing/proto/go/helloworldb\x06proto3"
